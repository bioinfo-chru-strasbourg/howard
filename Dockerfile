...
# Software Website:     https://gitlab.bioinfo-diag.fr/lebechec/HOWARD
...
LABEL Software="HOWARD" \
	Version="0.9b" \
	Website="https://gitlab.bioinfo-diag.fr/lebechec/HOWARD" \
	Description="HOWARD" \
...
#ENV TARBALL_LOCATION=https://gitlab.bioinfo-diag.fr/lebechec/HOWARD
#ENV TARBALL=howard.tar.gz
#ENV TARBALL_FOLDER=$TOOL_NAME
