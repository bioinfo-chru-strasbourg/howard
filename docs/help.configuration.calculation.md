...
- [<span class="toc-section-number">2</span> Calculation
  ...
  - [<span class="toc-section-number">2.11</span>
    output_column_number](#output_column_number)
  ...
  - [<span class="toc-section-number">2.18</span>
...
- *Description:* Specifies the VCF INFO/Tag type of the output column
  generated by the calculation (e.g., String, Integer, Float). Default
  "String".
...
- *Description:* Specifies the VCF INFO/Tag number of the output column
  generated by the calculation (e.g., 1 for one value, "." for multiple
  values, c.f. VCF format). Default ".".
