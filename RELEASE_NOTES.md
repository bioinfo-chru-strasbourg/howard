...
- Add pipeline mode to define multiple ordered steps of operations to process (between "annotation", "calculation" and "prioritization" operation types) ([#522](https://github.com/bioinfo-chru-strasbourg/howard/issues/522))
- Add docker tools to extend annotation with external tools ([#527](https://github.com/bioinfo-chru-strasbourg/howard/issues/527))
- Add VEP annotation through docker tools ([#565](https://github.com/bioinfo-chru-strasbourg/howard/issues/565))
...
- Improve calculation tool by adding named parameters on section ([#503](https://github.com/bioinfo-chru-strasbourg/howard/issues/503), [#505](https://github.com/bioinfo-chru-strasbourg/howard/issues/505)), and add/improve some pertinent calculations ([#496](https://github.com/bioinfo-chru-strasbourg/howard/issues/496), [#501](https://github.com/bioinfo-chru-strasbourg/howard/issues/501), [#519](https://github.com/bioinfo-chru-strasbourg/howard/issues/519), , [#519](https://github.com/bioinfo-chru-strasbourg/howard/issues/519))
- Improve Annovar annotation by adding supplementary configuration sections, and a specific 'parallelize' option to speedup the annotation process ([#508](https://github.com/bioinfo-chru-strasbourg/howard/issues/508) and [#550](https://github.com/bioinfo-chru-strasbourg/howard/issues/550))
- Clarification and homogenization of annotations fields for databases annotation (Parquet method, as well as Annovar, BCFtools, snpSift and BigWig) ([#514](https://github.com/bioinfo-chru-strasbourg/howard/issues/514))
