...
export SNPEFF_DATABASES=$NGS_DATABASES/snpeff/current		# DATA # NOT USED !!! # CHANGE DATABASE location in CONFIG FILE in SNPEFF TOOL if necessary
...
export ANNOVAR_DATABASES=$NGS_DATABASES/annovar/current		# DATA
