...
class Variants:
    ...
    def export_output(self, output_file: str = None, output_header: str = None, export_header: bool = True, query: str = None) -> bool:
        """
        ...
        # Export file
        database.export(output_database=output_file, output_header=output_header)
