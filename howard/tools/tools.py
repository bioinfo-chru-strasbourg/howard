...
arguments = {
    ...
    "input": {
        ...
        "gooey": {
            "widget": "FileChooser",
            "options": {
                "wildcard": "Parquet file (*.parquet)|*.parquet|" "All files (*)|*"
            },
        },
    },
    "output": {
    ...
    "annotations_update": {
        ...
        "gooey": {
            ...
            "options": {"checkbox_label": "Update annotation method"},
        },
    ...
    "annotations_append": {
        ...
        "gooey": {
            "widget": "BlockCheckbox",
            "options": {"checkbox_label": "Append annotation method"},
        },
        "extra": {"param_section": "annotation:options"},
    },
    # Calculations
    ...
    "prioritization_config": {
        ...
        "extra": {
            "param_section": "prioritization",
            "examples": {
                "Prioritization configuration JSON file as an option": """"prioritization_config": "prioritization_config.json" """
            },
        },
    },
    "profiles": {
    ...
    "query_limit": {
        ...
        "gooey": {
            "widget": "IntegerField",
            "options": {"min": 1, "max": 10000, "increment": 10},
        },
    },
    "query_print_mode": {
        "metavar": "print mode",
    ...
    "annovar_to_parquet": {
        ...
        "gooey": {
            "widget": "FileSaver",
            "options": {
                "wildcard": "HTML file (*.parquet)|*.parquet",
            },
        },
    },
    # "multi_variant": {
    ...
    "calculation_config": {
        ...
        "extra": {
            ...
            "examples": {
                "Calculation configuration JSON file as an option": """"calculation_config": "calculation_config.json" """
            },
        },
    },
    "show_calculations": {
    ...
    "hgvs_field": {
        ...
        "default": "hgvs",
        "type": str,
        "extra": {"param_section": "calculation:calculations:NOMEN:options"},
    },
    "transcripts": {
        "metavar": "transcripts",
        ...
        "gooey": {
            "widget": "FileChooser",
            "options": {"wildcard": "TSV file (*.tsv)|*.tsv|" "All files (*)|*"},
        },
        "extra": {"param_section": "calculation:calculations:NOMEN:options"},
    },
    "trio_pedigree": {
    ...
    "stats_md": {
        ...
        "gooey": {
            "widget": "FileSaver",
            "options": {"wildcard": "Markdown file (*.md)|*.md"},
        },
        "extra": {
            "examples": {
                "Export statistics in Markdown format": """"stats_md": "/tmp/stats.md" """
            }
        },
    },
    "stats_json": {
        ...
        "gooey": {
            "widget": "FileSaver",
            "options": {"wildcard": "JSON file (*.json)|*.json"},
        },
        "extra": {
            "examples": {
    ...
    "assembly": {
        ...
        "extra": {
            "examples": {
                "Default assembly for all analysis tools": """"assembly": "hg19" """,
                "List of assemblies for databases download tool": """"assembly": "hg19,hg38" """,
            }
        },
    },
    "genome": {
    ...
    "download-dbnsfp-parquet-size": {
        ...
        "gooey": {
            "widget": "IntegerField",
            "options": {"min": 1, "max": 100000, "increment": 10},
        },
    },
    ...
    "download-dbnsfp-row-group-size": {
        ...
        "gooey": {
            "widget": "IntegerField",
            "options": {"min": 1, "max": 100000000000, "increment": 10000},
        },
    },
    # AlphaMissense
    ...
    "download-dbsnp-assemblies-map": {
        ...
        "type": str,
        "gooey": {"options": {"initial_value": '{"hg19": "25", "hg38": "40"}'}},
    },
    "download-dbsnp-vcf": {
    ...
    "config": {
        ...
        "default": "{}",
        "type": str,
        "gooey": {"widget": "FileChooser", "options": {"initial_value": "{}"}},
    },
    "threads": {
        "metavar": "threads",
        ...
        "gooey": {
            "widget": "IntegerField",
            "options": {"min": -1, "max": 1000, "increment": 1},
        },
        "extra": {
            "examples": {
                "# Automatically detect all available CPU/cores": '"threads": -1',
                "# Define 8 CPU/cores": '"threads": 8',
            }
        },
    },
    "memory": {
    ...
    "tmp": {
        ...
        "extra": {
            "examples": {
                "# System temporary folder": '"tmp": "/tmp"',
                "# HOWARD work directory": '"tmp": "~/howard/tmp"',
                "# Current work directory": '"tmp": ".tmp"',
            }
        },
    },
    "duckdb_settings": {
        ...
        "extra": {
            "examples": {
                "DuckDB settings JSON file": '"duckdb_settings": "/path/to/duckdb_config.json"',
                "JSON string for Time zone, temporary directory and threads for duckDB": """\"duckdb_settings\": {\n"""
                """   \"TimeZone\": \"GMT\",\n"""
    ...
    "verbosity": {
        ...
        "extra": {
            "examples": {
                "Default verbosity": '"verbosity": "INFO"',
                "ERROR level (quiet mode)": '"verbosity": "ERROR"',
                "For debug": '"verbosity": "DEBUG"',
            }
        },
    },
    "access": {
    ...
    "log": {
        ...
        "extra": {
            "examples": {
                "Relative path to log file": '"log": "my.log"',
                "# HOWARD work directory": '"log": "~/howard/log"',
                "Full path to log file": '"log": "/tmp/my.log"',
            }
        },
    },
