...
tests_annotations_folder = (
    tests_databases_folder + f"/annotations/{tests_databases_release}/hg19"
)
...
tests_config = {
    ...
    "folders": {
        "databases": {
            "root": "",
            "annotations": [
                f"{tests_databases_folder}/annotations/{tests_databases_release}"
            ],
...
database_files = {
    ...
    "parquet_without_header": tests_annotations_folder
    + "/nci60.without_header.parquet",
    "duckdb": tests_annotations_folder + "/nci60.duckdb",
    "duckdb_no_annotation_table": tests_annotations_folder
    + "/nci60.no_annotation_table.duckdb",
    ...
    "tsv_alternative_columns": tests_annotations_folder
    + "/nci60.alternative_columns.tsv",
...
def download_needed_databases():
    ...
    databases_download_refseq(
        assemblies=[assembly], refseq_folder=refseq_folder, refseq_files=refseq_files
    )
